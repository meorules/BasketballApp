  ...
  public class BoxScore
  {
    ...
    public string FieldGoalPercentage
    {
      get
      {
        ...
        {
          return (100 * ((double)FieldGoalsMade / (double)FieldGoalsAttempted)).ToString() + "%";
        }
      }
    }
    ...
    public string ThreePercentage
    {
      get
      {
        ...
        {
          return (100 * ((double)ThreesMade / (double)ThreesAttempts)).ToString() + "%";
        }
      }
    }
    ...
    public string FreeThrowPercentage
    {
      get
      {
        ...
        {
          return (100 * ((double)FreeThrowMakes / (double)FreeThrowAttempts)).ToString() + "%";
        }
      }
    }
